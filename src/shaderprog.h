...
public:
	...
	// -------------------------------------------------------
	GLint GetLocSpotLightPos() const { return locSpotLightPosition; }
	GLint GetLocSpotLightDir() const { return locSpotLightDirection; }
	GLint GetLocSpotLightIntensity() const { return locSpotLightIntensity; }
	GLint GetLoclightconstant() const { return loclightconstant; }
	GLint GetLoclightlinear() const { return loclightlinear; }
	GLint GetLoclightquadratic() const { return loclightquadratic; }
...
private:
	...
	GLint loclightconstant;
	GLint loclightlinear;
	GLint loclightquadratic;
