...
void PhongShadingDemoShaderProg::GetUniformVariableLocation()
{
    ...
    loclightconstant = glGetUniformLocation(shaderProgId, "constant");
    loclightlinear = glGetUniformLocation(shaderProgId, "linear");
    loclightquadratic = glGetUniformLocation(shaderProgId, "quadratic");
